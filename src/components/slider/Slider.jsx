...
const Slider = () => {
  return (
    <div className="carousel-container" id="projects">
      <div className="carousel-title cipax">
        <h2>Mis Proyectos</h2>
        <h3>Junto a Cipax: 2023-2024</h3>
        <p>
          Trabajé en proyectos increíbles como parte de un equipo talentoso en{" "}
          <a
          ...
          resultados efectivos. Implementé aplicaciones web completas utilizando
          Laravel, WordPress, HTML, CSS, Bootstrap y Git, integrando APIs,
          optimizando bases de datos con Eloquent, y mejorando el rendimiento y
          la visibilidad en línea mediante estrategias de SEO, Google Analytics
      ...
      <div className="carousel-title">
        ...
        <p>
          ...
          construí interfaces dinámicas con React, combinando diseño y
          funcionalidades.
        </p>
      </div>
